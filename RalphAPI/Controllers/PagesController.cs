...
namespace RalphAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PagesController : ControllerBase
    {
        private readonly RalphAPIContext _context;

        public PagesController(RalphAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Page>> PostPage(Page page)
        {
            ...
            return CreatedAtAction("GetPage", new { id = page.Title }, page);
        }
